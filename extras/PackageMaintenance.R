...
OhdsiRTools::checkUsagePackage("StatinDrnVer1")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/StatinDrnVer1.pdf")
shell("R CMD Rd2pdf ./ --output=extras/StatinDrnVer1.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "StatinDrnVer1",
                                mode = "description",
